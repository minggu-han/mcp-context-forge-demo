...
public class AuthorizationServerConfig {
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authorize ->
                        authorize.requestMatchers("/.well-known/**", "/actuator/**").permitAll()
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient mcpClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://127.0.0.1:8081/login/oauth2/code/mcp-client")
        ...
        return new InMemoryRegisteredClientRepository(mcpClient, swaggerClient);
    }
